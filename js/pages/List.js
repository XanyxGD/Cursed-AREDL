        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        Join our discord server, and use the application form when there is one
                    </p>
                    <h3>> Submission Requirements</h3>
                    <p>
                        blah blah nothing matters everything here is cursed (you can use ignore damage, cheats, whatever)
                    </p>
                </div>
            </div>
        </main>
